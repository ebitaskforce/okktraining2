...
import { Users, Search, Shield, UserCheck, KeyRound, UserX, CheckCircle } from 'lucide-react';
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-6">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">
                Manage staff profiles, assign admin roles, reset security passwords, and toggle account activation
              </p>
            </div>
          </div>
